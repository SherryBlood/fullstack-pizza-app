...
$sql = "SELECT customer_id, first_name, last_name, email, phone_number, address FROM customers";
...
<body>
  ...
  <main>
    <section class="hero-section-clients-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Clients</h1>
      </div>
    </section>
    ...
    <section class="admin-client-info-section" id="client-info-section">
      <div class="container client-info-container">
        <div class="clients-info-head">
          <h4>Clients
        ...
        <div class="client-table-admin">
          <form method="post" action="update_clients_all.php" autocomplete="off">
                ...
                <?php foreach ($clients as $client): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      readonly></td>
                    <td>
                      <button class="form-button button change-password-btn" type="button"
                      data-email="<?= htmlspecialchars($client['email']) ?>"
                      data-id="<?= $client['customer_id'] ?>">
                      Change Password
                      </button>
                      <button 
                      class="form-button button delete-client-btn" 
                      type="button" 
                      data-id="<?= $client['customer_id'] ?>">Delete Client</button>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
  ...
  <div class="backdrop-admin-client-pass is-hidden">
    <div class="modal modal-pass-client">
      <button class="form-button modal-btn-close-pass button" type="button">Close</button>
      <h2>Change Password</h2>
      <form name="modal-form-admin-client-pass" method="post" action="new_password_client.php" autocomplete="off">
        <input type="hidden" name="client-id" id="modal-client-id">
        <div class="form-field">
          <label class="form-label visually-hidden" for="client-email-admin">Email</label>
          <input 
          class="form-input"
          type="email"
          name="client-email-admin"
          id="client-email-admin"
          placeholder="Email"
          required>
        </div>
        <div class="form-field">
          <label class="form-label visually-hidden" for="client-new-password-admin">New Password</label>
          <input 
          class="form-input"
          type="password"
          name="client-new-password-admin"
          id="client-new-password-admin"
          placeholder="New Password"
          required>
        </div>
        <div class="form-field">
          <label class="form-label visually-hidden" for="client-accept-password-admin">Confirm Password</label>
          <input 
          class="form-input"
          type="password"
          name="client-accept-password-admin"
          id="client-accept-password-admin"
          placeholder="Confirm Password"
          required>
        </div>
  ...
  <script src="modal-admin-client-password.js"></script>
  <script src="delete-client.js"></script>
