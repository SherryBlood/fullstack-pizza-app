...
$sql = "SELECT courier_id, first_name, last_name, phone_number FROM couriers";
...
<body>
  ...
  <main>
    <section class="hero-section-couriers-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Couriers</h1>
      </div>
    </section>
    ...
    <section class="admin-courier-info-section" id="courier-info-section">
      <div class="container client-info-container">
        <div class="couriers-info-head">
          ...
          <button class="form-button button modal-add-btn-open" type="button">Add Courier</button>
        ...
        <div class="client-table-admin">
          <form method="post" action="update_couriers_all.php" autocomplete="off">
              ...
              <tbody>
                <?php foreach ($couriers as $courier): ?>
                  <tr>
                    <td>
                      <input 
                      class="client-edit-input readonly-always" 
                      type="text" 
                      name="courier_ids[]" 
                    ...
                    <td>
                      ...
                      type="text" 
                      name="first_names[]" 
                      value="<?= htmlspecialchars($courier['first_name']) ?>" 
                      required  
                      readonly></td>
                    <td>
                      <input 
                      ...
                      type="text" 
                      name="last_names[]" 
                      value="<?= htmlspecialchars($courier['last_name']) ?>" 
                      required 
                      readonly></td>
                    <td>
                      <input 
                      ...
                      type="text" 
                      name="phones[]" 
                      value="<?= htmlspecialchars($courier['phone_number']) ?>"
                      pattern="^\+[0-9]{12}" 
                      required 
                      readonly></td>
                    <td>
                      ...
                      type="button" 
                      data-id="<?= $courier['courier_id'] ?>">Delete Courier</button>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
            <button class="form-button button save-changes-client-btn" type="submit" id="save-changes-client-btn" disabled>Save Changes</button>
          </form>
        </div>
      </div>
    </section>
  ...
  <div class="backdrop-admin-add-courier is-hidden">
    <div class="modal modal-add-courier">
      <button class="form-button modal-btn-close-add-courier button" type="button">Close</button>
      <h2>Add New Courier</h2>
      <form name="modal-form-admin-add-courier" method="post" action="new_courier.php" autocomplete="off">
        <input type="hidden" name="courier-id" id="modal-courier-id">
        <div class="form-field">
          <label class="form-label visually-hidden" for="courier-name">Name</label>
          <input 
          class="form-input" 
          type="text" 
          name="courier-name" 
        ...
        <div class="form-field">
          <label class="form-label visually-hidden" for="courier-last-name">Last Name</label>
          <input 
          class="form-input" 
          type="text" 
          name="courier-last-name" 
          id="courier-last-name"
          placeholder="Last Name"
          required>
        </div>
        <div class="form-field">
          <label class="form-label visually-hidden" for="courier-tel">Phone Number</label>
          <input 
          class="form-input" 
          type="tel" 
          name="courier-tel" 
        ...
        <button class="form-button button" type="submit">Add Courier</button>
      </form>
    </div>
  </div>
  <script src="modal.js"></script>
  <script src="admin-couriers.js"></script>
  <script src="modal-admin-couriers.js"></script>
  <script src="delete-courier.js"></script>
