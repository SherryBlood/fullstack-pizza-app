...
<body>
  ...
  <main>
    <section class="hero-section">
      <div class="container">
        <h1 class="hero-title">Pizza Tower</h1>
      </div>
    </section>
    ...
    <section class="menu-section" id="menu-section">
      <div class="container">
        <ul class="menu-client-page">
          <li><a class="menu-link menu-link-pizza" href="menu_pizzas_client_page.php">Pizza</a></li>
          <li><a class="menu-link menu-link-pizzarolls" href="menu_pizzarolls_client.php">Pizza Rolls</a></li>
          <li><a class="menu-link menu-link-snaks" href="menu_snaks_client.php">Snacks</a></li>
          <li><a class="menu-link menu-link-desserts" href="menu_desserts_client.php">Desserts</a></li>
          <li><a class="menu-link menu-link-drinks" href="menu_drinks_client.php">Drinks</a></li>
          <li><a class="menu-link menu-link-custompizza" href="menu_yourpizza_client.php">Custom Pizza</a></li>
          <li><a class="menu-link menu-link-promotions" id="promotions-section" href="menu_promotions_client.php">Promotions</a></li>
          <li><a class="menu-link menu-link-sets" href="menu_sets_client.php">Sets</a></li>
        </ul>
      </div>
    </section>
  </main>
