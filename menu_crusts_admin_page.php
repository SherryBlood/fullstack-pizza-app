...
$crustsQuery = "SELECT * FROM crusts";
$crustsResult = $conn->query($crustsQuery);
...
<body>
  ...
  <main>
    <section class="hero-section-menu-crusts-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Crusts</h1>
      </div>
    </section>
    ...
    <section class="admin-courier-info-section" id="courier-info-section">
      <div class="container client-info-container">
        <div class="couriers-info-head">
          ...
          <button class="form-button button modal-add-crust-btn-open" type="button">Add Crust</button>
        ...
        <div class="client-table-admin">
          <form method="post" action="update_crusts.php" autocomplete="off">
            <table class="admin-client-info-table">
              ...
              <tbody>
            <?php if ($crustsResult && $crustsResult->num_rows > 0): ?>
              <?php while ($crust = $crustsResult->fetch_assoc()): ?>
              <tr>
                <input type="hidden" name="crust_ids[]" value="<?= $crust['crust_id'] ?>">
                <td>
                  <input 
                  class="client-edit-input" 
                  type="text" 
                  name="names[]" 
                  value="<?= htmlspecialchars($crust['name']) ?>" 
                  required  
                  readonly>
                </td>
                <td>
                  ...
                  type="text" 
                  name="descriptions[]" 
                  value="<?= htmlspecialchars($crust['description']) ?>" 
                  required 
                  readonly>
                </td>
                <td>
                  ...
                  type="number" 
                  name="prices[]" 
                  value="<?= htmlspecialchars($crust['additional_price']) ?>" 
                  min="0" 
                  required 
                  readonly>
                </td>
                <td>
                  ...
                  type="button" 
                  data-id="<?= $crust['crust_id'] ?>">Delete</button>        
                </td>
              </tr>
              <?php endwhile; ?>
            <?php else: ?>
  ...
  <div class="backdrop-add-crust is-hidden">
    <div class="modal modal-add-crust">
      <button class="form-button modal-add-crust-btn-close button" type="button">Close</button>
      <h2>Add Crust</h2>
      <form name="modal-form-add-crust" method="post" action="admin_add_crust.php" autocomplete="off">
        <div class="form-field">
          <label class="form-label visually-hidden" for="crust-name">Name</label>
          <input 
          class="form-input" 
          type="text" 
          name="crust-name" 
        ...
        <div class="form-field">
          <label class="form-label visually-hidden" for="crust-description">Description</label>
          <textarea 
          class="form-input form-input-textarea" 
          rows="3" 
          name="crust-description" 
          id="crust-description"
          placeholder="Description"
          required></textarea>
        </div>
        <div class="form-field">
          <label class="form-label visually-hidden" for="crust-price">Price ($)</label>
          <input 
          class="form-input" 
          type="number" 
          name="crust-price" 
        ...
        <button class="form-button button button-add-crust" type="submit">Add Crust</button>
      </form>
    </div>
  </div>
  ...
  <script src="delete-crust.js"></script>
