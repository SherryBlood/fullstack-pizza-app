...
$productsQuery = "SELECT * FROM products WHERE category = 'dessert'";
...
<body>
  ...
  <main>
    <section class="hero-section-menu-desserts-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Desserts</h1>
      </div>
    </section>
