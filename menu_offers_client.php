...
$productsResult = $conn->query("SELECT * FROM products WHERE promotion_id IS NOT NULL");


$setsResult = $conn->query("SELECT * FROM sets");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main>
    <section class="hero-section-menu-offers">
      <div class="container">
