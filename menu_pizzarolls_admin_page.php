...
$productsQuery = "SELECT * FROM products WHERE category = 'pizza-roll'";
...
<body>
  ...
  <main>
    <section class="hero-section-menu-pizzarolls-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Pizza Rolls</h1>
      </div>
    </section>
