...
$productsQuery = "SELECT * FROM products WHERE promotion_id IS NOT NULL";
...
<body>
  ...
  <main>
    <section class="hero-section-menu-promotions-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Promotions</h1>
      </div>
    </section>
  ...
  <div class="backdrop-products-edit is-hidden">
    <div class="modal modal-products-edit">
      ...
      <form name="modal-form-edit-product" method="post" action="admin_edit_product.php" enctype="multipart/form-data" autocomplete="off">
        <div class="form-field">
          <label class="form-label visually-hidden" for="product-category-edit">Категорія</label>
          <select 
          class="form-input" 
