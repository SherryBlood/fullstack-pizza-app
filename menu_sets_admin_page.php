...
$productsQuery = "SELECT * FROM sets";
$setsResult = $conn->query($productsQuery);
...
<body>
  ...
  <main>
    <section class="hero-section-menu-sets-admin">
      <div class="container">
        <h1 class="hero-title hero-title-order">Sets</h1>
      </div>
    </section>
    ...
    <section class="menu-pizzas-section" id="menu-pizzas-section">
      <div class="products-container" id="products-container">
        <?php if ($setsResult && $setsResult->num_rows > 0): ?>
